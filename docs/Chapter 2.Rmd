...
It can be shown that if the stationary distribution exists then $\boldsymbol{\delta}$ be found using the following calculation:
...
To illustrate this concept, lets extend the example we used previously:
