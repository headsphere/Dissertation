...
To estimate the parameters $\theta$ of the mixture distribution via ML estimation is done by maximizing the combined likelihood of the components:
...
$$L(\lambda_1,\lambda_2,\delta_1,\delta2 | x_1,...,x_n) = \prod_{j=1}^n \Bigg( \delta_1 + \delta_2 \Bigg)$$
