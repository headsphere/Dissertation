...
```
```{r, fig.width = 10, fig.height = 7, fig.fullwidth = TRUE, echo=FALSE}
...
```
```{r, fig.width = 10, fig.height = 6, fig.fullwidth = TRUE, echo=FALSE}
...
```
```{r, fig.width = 10, fig.height = 4, fig.fullwidth = TRUE, echo=FALSE, eval=FALSE}
