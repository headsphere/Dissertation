...
This approach is not without its detractors however, and a long-running dispute has been simmering for the past several years with counterclaims attacking the viability of both the bulk-classification methodology [@Andersen2012a] and the predictive power of VPIN itself[@Andersen2014]. Partly due to this controvery we believe that this is a topic worth investigating further.  
